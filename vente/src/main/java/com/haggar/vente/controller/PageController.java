...
import com.haggar.vente.exception.ProductNotFoundException;
...
public class PageController {
	...
	public ModelAndView index () {
		...
		logger.info("Inside pageController index methode");
		logger.debug("Inside pageController index methode");
